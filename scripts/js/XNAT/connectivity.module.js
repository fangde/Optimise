...
connectivityModule.factory('Experiments', function ($resource) {
    return function(project, subjectID) {
        ...
        var url = "http://www.optimise-ms.org/api-optimise/xnat/proxy.php/data/projects/"+project+"/subjects/"+subjectID+"/experiments?format=json";
        return $resource(url,{},{});
    }
});
...
connectivityModule.factory('CIF_Data', function ($resource) {
    return function(subjectID) {
        var url = "http://www.optimise-ms.org/api-optimise/xnat/curlProxy.php/"+subjectID;
        return $resource(url,{},{});
    }
});
...
connectivityModule.factory('Scans', function ($resource) {
    return function(experimentURI) {
        ...
        var url = "http://www.optimise-ms.org/api-optimise/xnat/proxy.php/"+experimentURI+"/scans?format=json";
        return $resource(url,{},{});
    }
});
...
connectivityModule.factory('Resources', function ($resource) {
    return function(scanURI) {
        ...
        var url = "http://www.optimise-ms.org/api-optimise/xnat/proxy.php/"+scanURI+"/resources/?format=json";
        //console.log(url);
        return $resource(url,{},{});
    }
});
...
connectivityModule.factory('RawImage', function ($resource) {
    return function(experimentURI, resourceID) {
        ...
        var url = "http://www.optimise-ms.org/api-optimise/xnat/proxy.php/"+experimentURI+"/resources/"+resourceID+"/files?format=json";
        //console.log(url);
        return $resource(url,{},{});
    }
});
