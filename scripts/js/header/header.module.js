...
//            USUBJID.getSubjectData(url).get({USUBJID: $scope.USUBJID},function(data) {
//                data.$promise.then(function () {
//
//                    var RecordSet = data.RecordSet;
//                    //console.log(RecordSet);
//                    if (RecordSet.length > 0) {
//                        var aRecordItems = RecordSet[0].RecordItems;
//                        var domain = getDomain(aRecordItems);
//                        if (domain == 'DM') {
//                            for (var i = 0; i < aRecordItems.length; i++) {
//                                if (aRecordItems[i].fieldName == 'USUBJID') {
//                                    if ((aRecordItems[i].value != null)&&(aRecordItems[i].value!='')){
//                                        records.deleteSubject(aRecordItems[i].value);
//                                        break;
//                                    }
//
//                                }
...
//                        var domain = getDomain(aRecordItems);
//                        //console.log(domain);
//                        var seqFieldName = getSeqName(domain);
//                        //console.log(seqFieldName);
//                        var seqItem = getSeqItem(aRecordItems, seqFieldName);
//                        //console.log(seqItem);
//                        if (seqItem != null) {
//                            //console.log(seqItem);
//                            var jsonBody = records.formatForDeleteGivenDomain($scope.USUBJID, 'OPTIMISE', seqItem.fieldName, seqItem.value);
//                            console.log(jsonBody);
//                            //console.log($scope.USUBJID);
//                            records.deleteRecordGivenJSON(jsonBody);
//                        }
//                    }*/
//
//                })
//            });
    ...
    $scope.deleteEvent = function (event) {
        ...
        switch ($scope.contentOnDisplay) {
            ...
            case "Exposure":
            {
                ...
                exposures.deleteInteruptions(event.EXTRT);
    ...
    $scope.toggleTimeline = function (dataToToggle) {
        ...
        switch (dataToToggle) {
            case 'Treatments': {
                $scope.showTreatments = !$scope.showTreatments;
                break;
            }
            case 'Relapses': {
            ...
            case 'EDSS': {
                $scope.showEDSS = !$scope.showEDSS;
                break;
            }
            case 'MSQOL': {
                $scope.showMSQOL = !$scope.showMSQOL;
                break;
            }
            case 'VAS': {
                $scope.showVAS = !$scope.showVAS;
                break;
            }
            case 'PROMIS': {
                $scope.showPROMIS = !$scope.showPROMIS;
                break;
            }
            case 'PDDS': {
